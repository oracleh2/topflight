...
from .models import (
    ...
    Profile, ProfileFingerprint, ProfileLifecycle, ServerConfig, WorkerNode,
...
def create_app() -> FastAPI:
    ...
    """
    app = FastAPI(
        title=settings.app_name if hasattr(settings, 'app_name') else "Yandex Parser API",
