                    ...
                    Завершено {{ formatDateTime(task.completed_at) }}
                                ...
                                <div v-if="task.parameters" class="mt-2 text-sm text-gray-600">
                                    <div v-if="task.task_type === 'parse_serp'"
                                        ...
                                        <span>•</span>
                                        <span>Регион: {{
                                                task.parameters.region_code || '213'
                                            }}</span>
                                        <span>•</span>
                                        <span>Устройство: {{
                                                task.parameters.device_type || 'desktop'
                                            }}</span>
                                    </div>
                                    <div v-else-if="task.task_type === 'check_positions'"
                                         class="flex items-center space-x-4">
                                        <span>Ключевых слов: {{
                                                task.parameters.keyword_ids?.length || 0
                                            }}</span>
                                        <span>•</span>
                                        <span>Устройство: {{
                                                task.parameters.device_type || 'desktop'
                                ...
                                <div v-if="task.result && task.status === 'completed'"
                                    ...
                                    <div v-else-if="task.task_type === 'check_positions'">
                                        Проверено: {{ task.result.checked_keywords || 0 }} ключевых
                                        слов
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ml-4 flex items-center space-x-2">
                          ...
                          'block w-full text-left px-4 py-2 text-sm text-gray-700'
                                        ...
                                        <MenuItem
                                            v-if="task.task_type === 'parse_serp' && task.status === 'completed'"
                                            v-slot="{ active }">
                                            <button
